...
//
//        ParkingSpace p1 = new ParkingSpace(add1,false,new Credits(5.0),new TimeRange(30),null,user1);
//        ParkingSpace p2 = new ParkingSpace(add2,false,new Credits(15.0),new TimeRange(30),null,user2);
//        ParkingSpace p3 = new ParkingSpace(add3,false,new Credits(8.0),new TimeRange(30),null,user3);
//        ParkingSpace p4 = new ParkingSpace(add4,false,new Credits(3.0),new TimeRange(30),null,user4);
//        ParkingSpace p5 = new ParkingSpace(add5,false,new Credits(4.0),new TimeRange(30),null,user5);
//
...
//
//        ParkingRequest pr1 = new ParkingRequest(TimeRange.addMinutes(LocalDateTime.now(),60),new Pin(1541),user1,p2);
//        ParkingRequest pr2 = new ParkingRequest(TimeRange.addMinutes(LocalDateTime.now(),60),new Pin(1541),user2,p3);
//        ParkingRequest pr3 = new ParkingRequest(TimeRange.addMinutes(LocalDateTime.now(),60),new Pin(1541),user3,p4);
//        ParkingRequest pr4 = new ParkingRequest(TimeRange.addMinutes(LocalDateTime.now(),60),new Pin(1541),user4,p5);
//        ParkingRequest pr5 = new ParkingRequest(TimeRange.addMinutes(LocalDateTime.now(),60),new Pin(1541),user5,p1);
//
