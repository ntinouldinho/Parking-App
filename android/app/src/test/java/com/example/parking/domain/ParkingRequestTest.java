...
public class ParkingRequestTest {
    ...
    public void findOneParking() {
        ...
        assertEquals(1,(parkingRequest.findParking(parkingList,new Address("agias","53",new ZipCode(18500)),0,LocalDateTime.now())).size());
    }
    @Test
    public void findMultipleParking() {
        ...
        parkingList.add(testParking2);
         ...
         assertEquals(2,(parkingRequest.findParking(parkingList,new Address("agias","53",new ZipCode(18500)),0,LocalDateTime.now())).size());
    }
    @Test
